<script>
	...
	const socialIcons = [
		//   { path: 'M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z', name: 'facebook' },
		//   { path: 'M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z', name: 'twitter' },
		{
...
<!-- <nav class="fixed w-full z-50 bg-white/80 backdrop-blur-sm font-['Inter']">
	<div class="container mx-auto px-6 py-4 flex justify-between items-center">
		...
		<div class="flex items-center gap-8">
			<a href="#features" class="text-gray-600 hover:text-[#621C97] transition-colors">Features</a>
			<a href="#team" class="text-gray-600 hover:text-[#621C97] transition-colors">Team</a>
			<button
...
>
	<!-- Spinning social icons background - Outer Ring -->
	...
	<!-- Spinning social icons background - Inner Ring -->
	...
	<div class="text-center relative z-10 space-y-6 px-4">
		...
		<div class="flex justify-center gap-6 flex-wrap max-w-2xl mx-auto">
			{#each socialIcons as icon (icon.name)}
				<div
					class="w-14 h-14 bg-white rounded-full shadow-lg flex items-center justify-center
                     hover:scale-110 transition-transform hover:z-10 relative"
				>
